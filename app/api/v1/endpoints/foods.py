...
def create_food(
    ...
    background_tasks.add_task(
        manager.broadcast_to_all, {'type': 'menu_update', 'action': 'create'}
    )
    return food
...
def update_food_stock(
    ...
    background_tasks.add_task(
        manager.broadcast_to_all, {'type': 'menu_update', 'action': 'update_stock'}
    )
    return updated_food
...
def update_food(
    ...
    background_tasks.add_task(
        manager.broadcast_to_all, {'type': 'menu_update', 'action': 'update'}
    )
    return updated_food
...
def delete_food(
    ...
    if not food:
        raise HTTPException(status_code=404, detail='Food not found')
    background_tasks.add_task(
        manager.broadcast_to_all, {'type': 'menu_update', 'action': 'delete'}
    )
    return food
...
def upload_food_image(
    ...
    background_tasks.add_task(
        manager.broadcast_to_all, {'type': 'menu_update', 'action': 'update_image'}
    )
    return updated_food
